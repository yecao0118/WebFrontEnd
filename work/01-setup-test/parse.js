...
if( !structureCheck[0]) {
  console.error("ERROR: your HTML does not match the request structure (a ul that has li, and each li has one span elements)");
  process.exit(1);
}
...
const parts = ['name', 'neuid', 'email', 'slackhandle', 'github'];
const elements = {};
let hasErrors = false;
